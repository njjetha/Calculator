...
public class CalculatorTest extends TestCase {
    ...
    public void testFactTruePositive() {
        assertEquals("Factorial of the number for True Positive ",1,calculator.fact(0));
        assertEquals("Factorial of the number for True Positive",1,calculator.fact(1));
        assertEquals("Factorial of the number for True Positive",120,calculator.fact(5));
    }


    public void testFactFalsePositive() {
        assertNotEquals("Factorial of the number for False Positive ",0,calculator.fact(0));
        assertNotEquals("Factorial of the number for False Positive",0,calculator.fact(1));
        assertNotEquals("Factorial of the number for False Positive",0,calculator.fact(5));
    }
    ...
    public void testLogarithmTruePositive() {
        assertEquals("Logarithm of the number for True Positive ",0.0,calculator.logarithm(1));
